 ...
 *  pieces of the cellular automaton together and drives simulation, including maskless and masked people. <br>
 *  <br>
 *  Compilation:  javac MixedSIR.java <br>
 *  Execution:    java MixedSIR [double infectionRate] [double recoveryRate] [int maxDays] [int gridSize] [long frameDuration] <br>
 *  <br>
 *  Usage example:  java MixedSIR 0.13 0.33 90 50 50 <br>
 *      Animates a 50x50 grid of cells, about 10% of which are occupied at startup, and animates
 *      the grid at a speed of 50 milliseconds per frame for up to 90 days with an 13% infection and 33% recovery rate.
 *      Around 50% of the people are masked. <br>
 *  <br>
 *  Usage example: java MixedSIR <br>
 ...
 *      for up to 90 with an 16.6% infection rate and a 3.7% recovery rate, 50% masked.
 *  <br>
 *  @author Nisanur Genc, 2021
 */
public class MixedSIR implements CellularAutomaton {

    protected MixedSIRGrid grid;
     ...
     */
    public MixedSIR(double percentMasked, double infectionRate, double recoveryRate, int maxDays, int gridSize, long frameDuration, double populationDensity ){
        // Initialize the grid of cells
        grid = new MixedSIRGrid( gridSize );
        grid.populate( percentMasked, populationDensity, infectionRate, recoveryRate );
    ...
    public static void main(String[] args) {
        ...
        double percentMasked = 0.5; // percentage of the people who wear masks
        ...
        MixedSIR game = new MixedSIR(percentMasked, infectionRate, recoveryRate, maxDays, gridSize, frameDuration, populationDensity);
